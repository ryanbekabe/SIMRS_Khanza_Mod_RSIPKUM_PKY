        ...
        if(connection == null){
            try{
                ...
                System.out.println("\n\n  Koneksi ke Database berhasil.... IP komputer: "+inetAddress.getHostAddress()+ "\n\n" +
                        ...
                        "  1) Form/Java: RMPenilaianAwalKeperawatanRalan.java 0, SuratButaWarna.java 1, SuratBebasNarkoba.java 1, DlgIKBBayi.java 1, SuratKeteranganSehat.java 1, DlgPasienMati.java 1, SuratSakit.java 0, DlgCariPeriksaLab.java, DlgPermintaanLaboratorium.java, koneksiDB.java, sekuel.java;    \n"+
                        "   ) Form/Java: DlgCopyResep.java; DlgRawatJalan.java; DlgCariPeriksaLabPA.java;    \n"+
                        "  2) Report: rptBebasNarkoba.jasper, rptBebasNarkoba1.jasper, rptBebasNarkoba2.jasper, rptCetakPenilaianAwalKeperawatanRalan.jasper, rptPeriksaLab.jasper (Short), rptPeriksaLab2.jasper (Long), rptPeriksaLab3.jasper (Swab), rptSKL2.jasper 1, rptSuratKematian.jasper 1, rptSuratKeteranganSehat.jasper 1, rptSuratSakit5.jasper 0, rptSuratTidakButaWarna.jasper 1;     \n"+
                        "   ) Report: rptPeriksaLabPADTHJ.jasper dr. Frau, rptPeriksaLabPADTHJ2.jasper dr. Frau;      \n"+
                        "  3) Database: surat_skbn-no_surat(varchar 25 to 30);     \n"+
                        ...
                        "  Re-Compile_By: Bang Riyan Hidayat Samosir - www.HanyaJasa.Com - hanyajasa@gmail.com, 08.03 22/07/2024 - RS Islam PKU Muhammadiyah Palangka Raya.");
            }catch(Exception e){
