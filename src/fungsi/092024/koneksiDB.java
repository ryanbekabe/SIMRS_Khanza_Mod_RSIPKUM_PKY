        ...
        if(connection == null){
            try{
                ...
                System.out.println("\n\n  Koneksi ke Database berhasil.... IP komputer: "+inetAddress.getHostAddress()+ "\n\n" +
                        ...
                        "  5) Tambahan: Lengkapi SOAP dokter Rajal, Tambah Menu pada Periksa Lab. PA dan Cetak mode 1-2 MDT / Morfologi Darah Tepi, Disable Edit dan Hapus pada Obat Terlayani, Potensi PRB pada Label Barcode;     \n"+
                        "  Re-Compile_By: Bang Riyan Hidayat Samosir - www.HanyaJasa.Com - hanyajasa@gmail.com, 10.15 02/09/2024 - RS Islam PKU Muhammadiyah Palangka Raya.");
            }catch(Exception e){
