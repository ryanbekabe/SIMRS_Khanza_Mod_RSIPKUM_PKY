...
public final class DlgAuditCuciTanganMedis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PetugasRuang = new widget.TextBox();
        ...
        jLabel22.setText("Ruang/Unit:");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(490, 100, 80, 23);

        PetugasRuang.setName("PetugasRuang"); // NOI18N
        PetugasRuang.setPreferredSize(new java.awt.Dimension(310, 23));
        PetugasRuang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PetugasRuangKeyPressed(evt);
            }
        });
        FormInput.add(PetugasRuang);
        PetugasRuang.setBounds(580, 100, 210, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nip.getText().trim().equals("")||NamaPetugas.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("audit_cuci_tangan_medis","?,?,?,?,?,?,?,?","Data",8,new String[]{
                ...
                SebelumTehnik.getSelectedItem().toString(),SetelahTerpapar.getSelectedItem().toString(),SetelahKontak.getSelectedItem().toString(),SetelahLingkungan.getSelectedItem().toString(),PetugasRuang.getText().toString().trim()
            })==true){
                tampil();
                emptTeks();
            }  
    ...
    private void PetugasRuangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PetugasRuangKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PetugasRuangKeyPressed
    ...
    */
    ...
    private widget.TextBox PetugasRuang;
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "select audit_cuci_tangan_medis.nik,audit_cuci_tangan_medis.ruang,pegawai.nama,audit_cuci_tangan_medis.tanggal,audit_cuci_tangan_medis.sebelum_menyentuh_pasien,"+
                    "audit_cuci_tangan_medis.sebelum_tehnik_aseptik,audit_cuci_tangan_medis.setelah_terpapar_cairan_tubuh_pasien,"+
                    "audit_cuci_tangan_medis.setelah_kontak_dengan_pasien,audit_cuci_tangan_medis.setelah_kontak_dengan_lingkungan_pasien "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new String[]{
                        rs.getString("tanggal"),rs.getString("nik"),rs.getString("nama") + " - " + rs.getString("ruang"),rs.getString("sebelum_menyentuh_pasien"),rs.getString("sebelum_tehnik_aseptik"),
