        ...
        try{  
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement("select databarang.kode_brng,databarang.nama_brng,databarang.kode_kategori,detail_pemberian_obat.jml,"+
                        "detail_pemberian_obat.biaya_obat,detail_pemberian_obat.embalase,detail_pemberian_obat.tuslah,detail_pemberian_obat.total,kategori_barang.nama from "+
                        "detail_pemberian_obat inner join databarang on detail_pemberian_obat.kode_brng=databarang.kode_brng inner join kategori_barang on databarang.kode_kategori=kategori_barang.kode "+
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            tabMode.addRow(new String[]{
                                "",rs2.getString("nama_brng")+" - "+rs2.getString("kategori_barang.nama"),rs2.getString("jml")+"  x  "+Valid.SetAngka(rs2.getDouble("biaya_obat"))+
