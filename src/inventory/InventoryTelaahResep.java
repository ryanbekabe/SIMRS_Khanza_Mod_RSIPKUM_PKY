...
public final class InventoryTelaahResep extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ResepKontraIndikasiObat2 = new widget.ComboBox();
        KetResepKontraIndikasiObat2 = new widget.TextBox();
        ...
        ResepKontraIndikasiObat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        ResepKontraIndikasiObat2.setSelectedIndex(1);
        ResepKontraIndikasiObat2.setName("ResepKontraIndikasiObat2"); // NOI18N
        ResepKontraIndikasiObat2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ResepKontraIndikasiObat2KeyPressed(evt);
            }
        });
        FormInput.add(ResepKontraIndikasiObat2);
        ResepKontraIndikasiObat2.setBounds(700, 270, 80, 23);

        KetResepKontraIndikasiObat2.setFocusTraversalPolicyProvider(true);
        KetResepKontraIndikasiObat2.setName("KetResepKontraIndikasiObat2"); // NOI18N
        KetResepKontraIndikasiObat2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KetResepKontraIndikasiObat2KeyPressed(evt);
            }
        });
        FormInput.add(KetResepKontraIndikasiObat2);
        KetResepKontraIndikasiObat2.setBounds(650, 300, 140, 23);

        jLabel45.setText("Keterangan :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(560, 300, 80, 23);

        jLabel46.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel46.setText("9. High Alert");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(540, 270, 140, 23);
    ...
    private void ResepKontraIndikasiObat2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ResepKontraIndikasiObat2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ResepKontraIndikasiObat2KeyPressed

    private void KetResepKontraIndikasiObat2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetResepKontraIndikasiObat2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KetResepKontraIndikasiObat2KeyPressed
    ...
    */
    ...
    private widget.TextBox KetResepKontraIndikasiObat2;
    ...
    private widget.ComboBox ResepKontraIndikasiObat2;
