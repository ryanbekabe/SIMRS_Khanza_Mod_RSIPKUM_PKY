...
public final class RMPenilaianAwalKeperawatanRalan extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Hasil Penilaian Resiko Jatuh","Lapor Dokter","Pencegahan Pasien jatuh","Skrining Gizi 1","Nilai 1","Skrining Gizi 2","Nilai 2","Total Skor","Tingkat Nyeri","Provokes",
    ...
    private void initComponents() {
        ...
        HasilTindakan = new widget.ComboBox();
        LaporTindakan = new widget.ComboBox();
        ...
        internalFrame1.setMinimumSize(new java.awt.Dimension(559, 272));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1293));
        ...
        jLabel43.setBounds(40, 790, 460, 23);
        ...
        jLabel52.setBounds(10, 850, 380, 23);
        ...
        FormInput.add(BJM);
        BJM.setBounds(770, 620, 80, 23);

        jLabel67.setText("Menyebar :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(700, 950, 79, 23);
        ...
        jLabel68.setBounds(25, 680, 80, 23);
        ...
        FormInput.add(SG2);
        SG2.setBounds(520, 790, 160, 23);

        KetLapor.setEnabled(false);
        KetLapor.setFocusTraversalPolicyProvider(true);
        KetLapor.setFocusable(false);
        ...
        KetLapor.setBounds(610, 710, 20, 20);

        jLabel69.setText("Nilai :");
        jLabel69.setName("jLabel69"); // NOI18N
        FormInput.add(jLabel69);
        jLabel69.setBounds(690, 790, 75, 23);
        ...
        jLabel70.setBounds(40, 650, 530, 23);
        ...
        FormInput.add(SG1);
        SG1.setBounds(520, 760, 160, 23);

        jLabel72.setText("a. Cara Berjalan :");
        jLabel72.setName("jLabel72"); // NOI18N
        FormInput.add(jLabel72);
        jLabel72.setBounds(40, 600, 90, 23);
        ...
        Nilai1.setBounds(770, 760, 80, 23);

        MSA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        MSA.setName("MSA"); // NOI18N
        MSA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MSAActionPerformed(evt);
            }
        });
        ...
        FormInput.add(MSA);
        MSA.setBounds(580, 650, 80, 23);

        jLabel73.setText("Total Skor :");
        jLabel73.setName("jLabel73"); // NOI18N
        FormInput.add(jLabel73);
        jLabel73.setBounds(690, 820, 75, 23);
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(380, 870, 130, 23);
        ...
        Provokes.setBounds(580, 870, 130, 23);
        ...
        KetProvokes.setBounds(710, 870, 146, 23);

        jLabel80.setText("Penyebab :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(510, 870, 60, 23);
        ...
        Quality.setBounds(430, 900, 140, 23);
        ...
        KetQuality.setBounds(580, 900, 281, 23);

        jLabel81.setText("Kualitas :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(370, 900, 55, 23);

        jLabel82.setText("Wilayah :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(370, 930, 55, 23);
        ...
        Lokasi.setBounds(460, 950, 220, 23);

        jLabel83.setText("Lokasi :");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(400, 950, 60, 23);
        ...
        Menyebar.setBounds(780, 950, 80, 23);

        jLabel84.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel84.setText("Menit");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(820, 980, 35, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel85.setText("Skala Nyeri");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(430, 980, 60, 23);
        ...
        SkalaNyeri.setBounds(500, 980, 70, 23);

        jLabel86.setText("Diberitahukan pada dokter ?");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(480, 1020, 150, 23);
        ...
        Durasi.setBounds(730, 980, 80, 23);

        jLabel87.setText("Waktu / Durasi :");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(630, 980, 90, 23);

        jLabel88.setText("Severity :");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(370, 980, 55, 23);
        ...
        NyeriHilang.setBounds(140, 1020, 130, 23);
        ...
        KetNyeri.setBounds(270, 1020, 150, 23);

        jLabel89.setText("Nyeri hilang bila :");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(10, 1020, 130, 23);
        ...
        PadaDokter.setBounds(640, 1020, 80, 23);
        ...
        KetDokter.setBounds(780, 1020, 80, 23);

        jLabel92.setText("Nilai :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(690, 760, 75, 23);
        ...
        TotalHasil.setBounds(770, 820, 80, 23);

        TglAsuhan.setForeground(new java.awt.Color(50, 70, 50));
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-12-2022 12:34:26" }));
        ...
        jLabel97.setBounds(530, 680, 30, 23);
        ...
        jSeparator7.setBounds(0, 740, 880, 1);
        ...
        jSeparator8.setBounds(0, 850, 880, 1);

        jLabel74.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel74.setText("VII. SKRINING GIZI");
        jLabel74.setName("jLabel74"); // NOI18N
        FormInput.add(jLabel74);
        jLabel74.setBounds(10, 740, 380, 23);
        ...
        PanelWall.setBounds(40, 870, 320, 130);
        ...
        jSeparator9.setBounds(370, 870, 1, 140);

        jLabel71.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel71.setText("Tindakan :");
        jLabel71.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(25, 710, 80, 23);
        ...
        jSeparator10.setBounds(0, 1050, 880, 1);
        ...
        Scroll6.setBounds(20, 1060, 400, 143);

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(30, 1210, 60, 23);
        ...
        BtnTambahMasalah.setBounds(380, 1210, 28, 23);
        ...
        BtnAllMasalah.setBounds(340, 1210, 28, 23);
        ...
        BtnCariMasalah.setBounds(310, 1210, 28, 23);
        ...
        TabRencanaKeperawatan.setBounds(450, 1060, 420, 143);
        ...
        TCariMasalah.setBounds(90, 1210, 215, 23);
        ...
        BtnTambahRencana.setBounds(820, 1210, 28, 23);
        ...
        BtnAllRencana.setBounds(790, 1210, 28, 23);
        ...
        BtnCariRencana.setBounds(750, 1210, 28, 23);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(450, 1210, 60, 23);
        ...
        TCariRencana.setBounds(520, 1210, 235, 23);

        HasilTindakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "(Tidak Beresiko) Tidak ada tindakan", "(Resiko Rendah) Edukasi", "(Resiko Tinggi) Edukasi, pasang kalung penanda resiko jatuh" }));
        HasilTindakan.setName("HasilTindakan"); // NOI18N
        HasilTindakan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HasilTindakanActionPerformed(evt);
            }
        });
        ...
        FormInput.add(HasilTindakan);
        HasilTindakan.setBounds(80, 710, 450, 23);

        LaporTindakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        LaporTindakan.setName("LaporTindakan"); // NOI18N
        LaporTindakan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                LaporTindakanKeyPressed(evt);
            }
        });
        FormInput.add(LaporTindakan);
        LaporTindakan.setBounds(580, 710, 20, 23);

        jLabel78.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel78.setText("Pengkajian");
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(25, 580, 90, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-12-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-12-2022" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",57,new String[]{
                    ...
                    KetEdukasi.getText(),ATS.getSelectedItem().toString(),BJM.getSelectedItem().toString(),MSA.getSelectedItem().toString(),Hasil.getSelectedItem().toString(),Lapor.getSelectedItem().toString(),HasilTindakan.getSelectedItem().toString(), 
                    ...
                    Durasi.getText(),NyeriHilang.getSelectedItem().toString(),KetNyeri.getText(),PadaDokter.getSelectedItem().toString(),LaporTindakan.getSelectedItem().toString(),Rencana.getText(),KdPetugas.getText()
                })==true){
    ...
    private void LaporTindakanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LaporTindakanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_LaporTindakanKeyPressed
    ...
    private void MSAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MSAActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MSAActionPerformed

    private void HasilTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HasilTindakanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_HasilTindakanActionPerformed
    ...
    */
    ...
    private widget.ComboBox HasilTindakan;
    ...
    private widget.ComboBox LaporTindakan;
...
//            KetLapor.setText(tbObat.getValueAt(tbObat.getSelectedRow(),61).toString());
    ...
    private void isMenu(){
        if(ChkAccor.isSelected()==true){
            ...
            LaporTindakan.setVisible(false);
