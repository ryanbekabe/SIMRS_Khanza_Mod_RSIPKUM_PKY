...
public class DlgCariPeriksaLabPA extends javax.swing.JDialog {
    ...
    public DlgCariPeriksaLabPA(java.awt.Frame parent, boolean modal) {
        ...
        DiagnosaKlinis.setDocument(new batasInput((int)5024).getKata(DiagnosaKlinis));
        Makroskopis.setDocument(new batasInput((int)5024).getKata(Makroskopis));
        Mikroskopis.setDocument(new batasInput((int)5024).getKata(Mikroskopis));
        Kesimpulan.setDocument(new batasInput((int)5024).getKata(Kesimpulan));
        Kesan.setDocument(new batasInput((int)5024).getKata(Kesan));
    ...
    private void initComponents() {
        ...
        MnCetakHasilLab3.setActionCommand("Cetak Hasil Lab 2");
        ...
        MnCetakHasilLab4.setActionCommand("Cetak Hasil Lab 2");
        ...
        label17.setBounds(15, 69, 230, 23);
        ...
        label19.setBounds(15, 263, 230, 23);
        ...
        label20.setBounds(15, 457, 230, 23);
