...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratSKBN3.setText("Cetak SKBN 4 - Ok");
        ...
        jLabel3.setText("(No.Srt)/71024/LAB/(BLN)/(THN)");
        jLabel3.setName("jLabel3"); // NOI18N
        FormInput.add(jLabel3);
        jLabel3.setBounds(60, 60, 190, 23);
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-12-2022" }));
        ...
        TanggalSurat.setBounds(440, 40, 90, 23);

        jLabel13.setText("Tanggal Surat :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(340, 40, 90, 23);

        jLabel20.setText("Ganja / Canabis :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(370, 130, 10, 23);
        ...
        TDokter.setBounds(180, 90, 204, 23);
        ...
        btnDokter.setBounds(380, 90, 28, 23);

        jLabel5.setText("Parameter Pemeriksaan :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(10, 130, 130, 23);
        ...
        jLabel23.setText("2) Opiat / Morphin :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(360, 130, 135, 23);
        ...
        hasil2.setBounds(480, 130, 10, 23);

        jLabel24.setText("Amphetamin :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(370, 100, 10, 23);

        jLabel25.setText("1) Methamphetamin :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(150, 130, 110, 23);

        jLabel26.setText("Benzodiazepin :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(601, 100, 10, 23);
        ...
        hasil4.setBounds(280, 130, 100, 23);
        ...
        hasil3.setBounds(479, 100, 10, 23);
        ...
        hasil5.setBounds(705, 100, 10, 23);

        jLabel27.setText("Cocain :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(601, 130, 10, 23);
        ...
        hasil6.setBounds(705, 130, 10, 23);

        jLabel8.setText("No. Surat :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 40, 70, 23);

        jLabel9.setText("Dokter :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 90, 70, 23);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                //param.put("logo",Sequel.cariGambar("select setting.logoBKB from setting")); 
    ...
    */
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            hasil2.setVisible(false);
            jLabel24.setVisible(false);
            hasil3.setVisible(false);
            jLabel26.setVisible(false);
            hasil5.setVisible(false);
            jLabel27.setVisible(false);
            hasil6.setVisible(false);
