...
public final class SuratSakit extends javax.swing.JDialog {
    ...
    public SuratSakit(java.awt.Frame parent, boolean modal) {
        ...
        NoSurat.setDocument(new batasInput((byte)30).getKata(NoSurat)); //Modif Edit 17 jadi 30
    ...
    private void initComponents() {
        ...
        MnCetakSuratSakit.setText("Cetak Surat Sakit 1 - Oke");
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-09-2024" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-09-2024" }));
...
//                param.put("finger","https://rsipalangkaraya.online/suratsakit/?token="+EnkripsiAES.encrypt(NoSurat.getText()));
                param.put("finger","https://rsipalangkaraya.online/verifqr/?id="+EnkripsiAES.encrypt("{'x':'sks','t':'"+NoSurat.getText()+"'}"));
    ...
    private void MnCetakSuratSakit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakit2ActionPerformed
        if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
                ...
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",kodedokter);
//                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+namadokter+"\nID "+(finger.equals("")?kodedokter:finger)+"\n"+Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));  
                param.put("finger","https://rsipalangkaraya.online/suratsehat/?token="+EnkripsiAES.encrypt(NoSurat.getText())); 
