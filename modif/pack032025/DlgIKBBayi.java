//UmurIbu,UmurAyah,TCariRMIbu: label20, label35, DefaultTableModel, NoSKL.setDocument(new batasInput, UmurIbu.setDocument(new batasInput, UmurAyah.setDocument(new batasInput
...
public class DlgIKBBayi extends javax.swing.JDialog {
    ...
    public DlgIKBBayi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Umur","Tgl.Daftar","Nama Ibu","Tgl Lhr Ibu","Nama Ayah",
            "Tgl Lhr Ayah","Alamat Ibu","B.B.","P.B.",
        ...
        TCariRMIbu.setDocument(new batasInput((byte)100).getKata(TCariRMIbu));
    ...
    private void initComponents() {
        ...
        MnSKL.setText("Surat Keterangan Lahir 1 - Tunggal");
        ...
        MnSKL1.setText("Surat Keterangan Lahir 2 - Kembar");
        ...
        jLabel1.setText("* No. RM Ibu :");
        jLabel1.setName("jLabel1"); // NOI18N
        panelisi2.add(jLabel1);

        TCariRMIbu.setName("TCariRMIbu"); // NOI18N
        TCariRMIbu.setPreferredSize(new java.awt.Dimension(140, 23));
        TCariRMIbu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TCariRMIbuKeyPressed(evt);
            }
        });
        panelisi2.add(TCariRMIbu);
    ...
    private void MnSKLActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSKLActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>();    
                ...
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());   
                param.put("finger","https://verifqr.rsipalangkaraya.co.id/verifqr/?id="+EnkripsiAES.encrypt("{'x':'skl','t':'"+NoSKL.getText()+"'}"));
//                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
//                param.put("logo2",Sequel.cariGambar("select setting.logo from setting")); 
            ...
            if(TCariRMIbu.getText().length()>0){
                JOptionPane.showMessageDialog(null,"NIP Ibu bayi akan terisi otomatis berdasarkan * No. RM Ibu bayi yang Anda isi.");
                Valid.MyReportqry("rptSKL1.jasper","report","::[ Surat Kelahiran Bayi ]::",
                       "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.jk, "+
                        ...
                        "pasien.tgl_daftar,pasien.nm_ibu as nama_ibu_bayi,(SELECT pasien.no_ktp FROM pasien WHERE pasien.no_rkm_medis = '"+TCariRMIbu.getText()+"') AS ktp_ibu,dokter.kd_dokter,dokter.nm_dokter,dokter.no_ijn_praktek,pasien_bayi.umur_ibu, "+
            ...
            if(TCariRMIbu.getText().length()==0){
                JOptionPane.showMessageDialog(null,"NIP Ibu bayi akan terisi otomatis tanpa berdasarkan * No. RM Ibu.");
                Valid.MyReportqry("rptSKL1.jasper","report","::[ Surat Kelahiran Bayi ]::",
                       "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.jk, "+
                        "pasien.tgl_lahir,pasien_bayi.jam_lahir, pasien.umur,pasien.pekerjaanpj, "+
...
//                        "where pasien_bayi.no_rkm_medis='"+NoRm.getText()+"'",param);            
    ...
    private void MnSKL1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSKL1ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            param.put("kontakrs",akses.getkontakrs());
            param.put("emailrs",akses.getemailrs());
            param.put("finger","https://verifqr.rsipalangkaraya.co.id/verifqr/?id="+EnkripsiAES.encrypt("{'x':'skl2','t':'"+NoSKL.getText()+"'}"));
//            param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
//            param.put("logo2",Sequel.cariGambar("select setting.logo from setting"));
            param.put("logo",Sequel.cariGambar("select gambar.kopsurat from gambar"));
...
//                "where pasien_bayi.no_rkm_medis='"+NoRm.getText()+"'",param);
    ...
    private void TCariRMIbuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCariRMIbuKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TCariRMIbuKeyPressed
    ...
    */
    ...
    private widget.TextBox TCariRMIbu;
