/*NoSurat.setDocument(new batasInput,
...
public final class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    private int i=0;
    private String tgl,finger="",kodedokter="",namadokter="",sipdokter="";
    ...
    private void initComponents() {
        ...
        MnCetakSuratSehat.setText("Cetak Surat Sehat 1 - Oke");
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-02-2025" }));
    ...
    private void MnCetakSuratSehatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehatActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("finger","https://verifqr.rsipalangkaraya.co.id/verifqr/?id="+EnkripsiAES.encrypt("{'x':'ske','t':'"+NoSurat.getText()+"'}"));
                Valid.MyReportqry("rptSuratKeteranganSehat.jasper","report","::[ Surat Keterangan Sehat ]::",
                              ...
                              " surat_keterangan_sehat.butawarna,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,dokter.nm_dokter,dokter.no_ijn_praktek,pasien.jk,reg_periksa.kd_dokter," +
                              " pasien.nm_pasien,pasien.tmp_lahir,pasien.tgl_lahir,pasien.pekerjaan,pasien.namakeluarga,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
