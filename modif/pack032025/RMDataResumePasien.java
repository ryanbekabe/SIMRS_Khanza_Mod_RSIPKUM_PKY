...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kondisi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Hidup", "Sembuh", "Membaik", "Meninggal", "Pulang Paksa" }));
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("finger","https://verifqr.rsipalangkaraya.co.id/verifqr/?id="+EnkripsiAES.encrypt("{'x':'skr','t':'"+TNoRw.getText()+"'}"));
