...
public final class DlgRl38 extends javax.swing.JDialog {
    ...
    public DlgRl38(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","Jenis Kegiatan","Jumlah","L","P"};
        ...
        try {            
            pstindakan=koneksi.prepareStatement("select jns_perawatan_lab.nm_perawatan,count(jns_perawatan_lab.nm_perawatan),jns_perawatan_lab.kd_jenis_prw,SUM(CASE WHEN pasien.jk = 'L' THEN 1 ELSE 0 END) AS L,SUM(CASE WHEN pasien.jk = 'P' THEN 1 ELSE 0 END) AS P from periksa_lab "+
        ...
        try{   
            ...
            while(rstindakan.next()){
                tabMode.addRow(new Object[]{
                    i,rstindakan.getString(1),rstindakan.getInt(2),rstindakan.getString(4),rstindakan.getString(5)
                });
