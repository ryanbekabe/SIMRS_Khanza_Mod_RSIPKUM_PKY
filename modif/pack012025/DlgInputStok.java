...
//        Object[] row={"Real","Kode Barang","Nama Barang","Jenis","Satuan","Harga","Stok","Selisih","Lebih","Nominal Hilang(Rp)","Nominal Lebih(Rp)","No.Batch","No.Faktur"};
        Object[] row={"Real","Kode Barang","Nama Barang","Jenis","Satuan","Harga","Stok","Selisih","Lebih","Nominal Hilang(Rp)","Nominal Lebih(Rp)","No.Batch","No.Faktur","Ekspired"};
        tabMode=new DefaultTableModel(null,row){
            @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if ((colIndex==0)||(colIndex==11)||(colIndex==12)||(colIndex==13)) {
                    a=true;
                }
                return a;
             }
        ...
        if(nmgudang.getText().trim().equals("")||kdgudang.getText().trim().equals("")){
            ...
            try{  
                ...
                pstampil=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat, "+
                        "databarang."+hppfarmasi+" as dasar,databarang.expire from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                ...
                try {
                    ...
                    while(rstampil.next()){                            
                        tabMode.addRow(new Object[]{"",rstampil.getString("kode_brng"),
                                       ...
                                       rstampil.getDouble("dasar"),0,0,0,0,0,"","",rstampil.getString("expire")});
                    }  
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                } finally{
        ...
        if(kdgudang.getText().equals("")){
            try{  
                ...
                pstampil=koneksi.prepareStatement(
                    ...
                    "data_batch.sisa,data_batch.no_batch,data_batch.no_faktur,databarang.expire from data_batch inner join databarang on data_batch.kode_brng=databarang.kode_brng "+
                ...
                try {
                    ...
                    while(rstampil.next()){                            
                        tabMode.addRow(new Object[]{
                            ...
                            rstampil.getDouble("dasar"),rstampil.getDouble("sisa"),0,0,0,0,rstampil.getString("no_batch"),rstampil.getString("no_faktur"),rstampil.getString("expire")
                        });
                        iyem=iyem+"{\"KodeBarang\":\""+rstampil.getString("kode_brng")+"\",\"NamaBarang\":\""+rstampil.getString("nama_brng").replaceAll("\"","")+"\",\"Kategori\":\""+rstampil.getString("nama")+"\",\"Satuan\":\""+rstampil.getString("kode_sat")+"\",\"Harga\":\""+rstampil.getString("dasar")+"\",\"NoBatch\":\""+rstampil.getString("no_batch")+"\",\"NoFaktur\":\""+rstampil.getString("no_faktur")+"\",\"Stok\":\""+rstampil.getDouble("sisa")+"\",\"Expire\":\""+rstampil.getString("expire")+"\"},";
                    }  
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                } finally{
            ...
            try{  
                ...
                pstampil=koneksi.prepareStatement(
                    "select data_batch.kode_brng,databarang.nama_brng,jenis.nama,databarang.kode_sat,data_batch."+hppfarmasi+" as dasar, "+
                    "gudangbarang.stok as sisa,data_batch.no_batch,data_batch.no_faktur,databarang.expire from data_batch inner join databarang on data_batch.kode_brng=databarang.kode_brng "+
