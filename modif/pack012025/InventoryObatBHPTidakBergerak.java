...
public class InventoryObatBHPTidakBergerak extends javax.swing.JDialog {
    ...
    public InventoryObatBHPTidakBergerak(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Barang", "Nama Barang", "Satuan", "Jenis","Stok","Harga","Nilai Aset","Ekspired"};
    ...
    private void prosesCari() {
       ...
       try{   
            ...
            ps=koneksi.prepareStatement(
                    "select databarang.kode_brng,databarang.nama_brng,kodesatuan.satuan,jenis.nama,databarang."+hppfarmasi+" as harga,databarang.expire "+
                ...
                while(rs.next()){ 
                    ...
                    if(stok>0){
                        tabMode.addRow(new Object[]{
                            ...
                            stok,Valid.SetAngka(rs.getDouble("harga")),Valid.SetAngka(stok*rs.getDouble("harga")),rs.getString("expire")
