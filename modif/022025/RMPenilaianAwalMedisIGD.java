 ...
 * Modif 19022025: rekammedis/RMPenilaianAwalMedisIGD.java (1) (V. DIAGNOSIS/ASESMEN DAN RETRIASE, BtnEdit disable jika Ranap); | Riyan Hidayat Samosir | hanyajasa@gmail.com | www.hanyajasa.com
 */
...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,psb,psc;
    private ResultSet rs,rsb,rsc;
    private int i=0;
    ...
    private void initComponents() {
        ...
        jLabel102.setText("V. DIAGNOSIS/ASESMEN DAN RETRIASE");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(10, 980, 240, 23);
    ...
    private void tbObatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbObatMouseClicked
        if(tabMode.getRowCount()!=0){
            try {
                getData();
//                System.out.println("getdata tbObatMouseClicked1985");
    ...
    private void tbObatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbObatKeyPressed
        if(tabMode.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getData();
//                System.out.println("getdata tbObatMouseClicked2002");
                } catch (java.lang.NullPointerException e) {
                }
...
//            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisIGD.jasper","report","::[ Laporan Penilaian Awal Medis IGD ]::",
                ...
                "penilaian_medis_igd.ket_lokalis,penilaian_medis_igd.ekg,penilaian_medis_igd.rad,penilaian_medis_igd.lab,penilaian_medis_igd.diagnosis,penilaian_medis_igd.tata,dokter.nm_dokter,dokter.no_ijn_praktek "+
...
//            System.out.println("getData 2541 : "+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
//            System.out.println("getData 2542 : "+tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
            System.out.println("Pasien : "+tbObat.getValueAt(tbObat.getSelectedRow(),2).toString());
//            System.out.println("getData 2544 : "+tbObat.getValueAt(tbObat.getSelectedRow(),3).toString());

        try {
            ps=koneksi.prepareStatement(
                    "SELECT penilaian_medis_igd.no_rawat, penilaian_medis_igd.tanggal," +
                    "penilaian_medis_igd.kd_dokter, reg_periksa.status_lanjut " +
                    "FROM reg_periksa " +
                    "INNER JOIN penilaian_medis_igd ON reg_periksa.no_rawat = penilaian_medis_igd.no_rawat " +
            ...
            try {
                ...
                if(rs.next()){
                    found = true;
                    statlanjut=rs.getString("status_lanjut");
                    System.out.println("Data ditemukan:");
                    System.out.println("No Rawat      : " + rs.getString("no_rawat"));
                    System.out.println("Tanggal       : " + rs.getString("tanggal"));
                    System.out.println("Kode Dokter   : " + rs.getString("kd_dokter"));
                    System.out.println("Status Lanjut : " + statlanjut);
//                    System.out.println("Status Lanjut : " + rs.getString("status_lanjut"));
                    System.out.println("--------------------------------------");
                    if(statlanjut.equals("Ranap")){
//                        BtnEdit.setVisible(false); // .setEnabled(false);
                        BtnEdit.setEnabled(false);
//                        BtnEdit.isVisible(false);
//                        System.out.println("Status Lanjut Ranap disable edit ");
                    }
                    if(statlanjut.equals("Ralan")){
//                        BtnEdit.setVisible(true);
                        BtnEdit.setEnabled(true);
    //                        BtnEdit.isVisible(true);
//                        System.out.println("Status Lanjut Ralan enable edit ");
                    }
                    //Data ditemukan:
                    //No Rawat      : 2025/01/14/000261
                    //Tanggal       : 2025-01-15 01:34:23.0
                    //Kode Dokter   : 19021998
                    //Status Lanjut : Ranap
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
