        ...
        if(connection == null){
            try{
                ...
                System.out.println("  Koneksi Berhasil. Sorry bro loading, silahkan baca dulu.... \n\n"+
                        ...
                        "   ) Form/Java: inventory/DlgCopyResep.java (1) (Silakan konfirmasi ke bagian Farmasi); inventory/DlgResepObat.java (1); simrskhanza/DlgRawatJalan.java (1) (Suhu harap dilengkapi, dll...); rekammedis/RMPenilaianAwalMedisIGD.java (1) (V. DIAGNOSIS/ASESMEN DAN RETRIASE); simrskhanza/DlgAbout.java (1); simrskhanza/DlgCariPeriksaLabPA.java (1) (MDT 1-3); surat/SuratBebasNarkoba.java (1);   \n"+
                        ...
                        "  Re-Compile_by: Bang Riyan Hidayat Samosir - www.HanyaJasa.Com - hanyajasa@gmail.com, 14.09 24/10/2024 - RS Islam PKU Muhammadiyah Palangka Raya. \n"+
                        "                                                                           ");
            }catch(Exception e){
