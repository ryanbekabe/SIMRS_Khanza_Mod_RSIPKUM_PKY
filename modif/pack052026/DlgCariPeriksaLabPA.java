//simrskhanza/DlgCariPeriksaLabPA.java (1) (MDT 1-3, batasInput 1024); modif: label14,label17,label19,label20,
package simrskhanza;
...
public class DlgCariPeriksaLabPA extends javax.swing.JDialog {
    ...
    private String kamar,namakamar,datapasien="",finger="",sipdokter="";
    ...
    public DlgCariPeriksaLabPA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//        JOptionPane.showMessageDialog(this, utama.getLblUserValue(), "User Aktif", JOptionPane.INFORMATION_MESSAGE);
        Object[] row={"No.Rawat","No.Permintaan","Pasien","Petugas","Tgl.Periksa","Jam Periksa","Dokter Perujuk","Penanggung Jawab","Pemeriksaan","Biaya","Diagnosa Klinis","Makroskopik","Mikroskopik","Kesimpulan","Kesan","Kode Periksa","Cara Bayar"};
        ...
        DiagnosaKlinis.setDocument(new batasInput((int)1024).getKata(DiagnosaKlinis));
        ...
        Kesimpulan.setDocument(new batasInput((int)1024).getKata(Kesimpulan));
        Kesan.setDocument(new batasInput((int)1024).getKata(Kesan));
    ...
    private void initComponents() {
        ...
        MnCetakHasilLab2.setText("Cetak Hasil Lab 2 - OKE dr. Anas");
        ...
        MnCetakHasilLab3.setText("Cetak Hasil Lab 3 - MDT 1");
        ...
        MnCetakHasilLab4.setText("Cetak Hasil Lab 4 - MDT 2");
        ...
        MnCetakHasilLab5.setText("Cetak Hasil Lab 5 - MDT 3");
        ...
        MnCetakHasilLab6.setText("Cetak Hasil - Sputum Gram");
        ...
        scrollPane3.setBounds(15, 107, 385, 170);
        ...
        scrollPane5.setBounds(15, 495, 385, 50);
        ...
        label21.setBounds(15, 551, 90, 23);
        ...
        scrollPane6.setBounds(15, 569, 385, 50);
    ...
    private void MnCetakHasilLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {   
                ...
                try {
                    ps4.setString(1,tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString());
                    ps4.setString(2,tbDokter.getValueAt(tbDokter.getSelectedRow(),5).toString());
    ...
    private void btnUbahPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahPasswordActionPerformed
        if(tbDokter.getSelectedRow()!= -1){
            if(Sequel.mengedittf("detail_periksa_labpa","no_rawat=? and kd_jenis_prw=? and tgl_periksa=? and jam=?","diagnosa_klinik=?,makroskopik=?,mikroskopik=?,kesimpulan=?,kesan=?",9,new String[]{
                ...
                tbDokter.getValueAt(tbDokter.getSelectedRow(),15).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),5).toString()
            })==true){
                tampil();
            ...
            if(tabMode.getRowCount()==0){
                ...
                for(i=0;i<row;i++){
                    Sequel.menyimpan("temporary_lab","'"+i+"','"+
                        ...
                        tabMode.getValueAt(i,14).toString()+"','','','','','','','','','','','','','','','','','','','','','','',''","Periksa Lab");
                }
                    ...
                    if (reply == JOptionPane.YES_OPTION) {
                        try{
                            ...
                            ttljmdokter=Sequel.cariIsiAngka("select sum(tarif_tindakan_dokter) from periksa_lab where periksa_lab.kategori='PA' and no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0) +
                                "' and tgl_periksa='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),4) +
                                "' and jam='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),5) +
                                "' and kd_jenis_prw='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),15).toString()+"'");
                            ...
                            if(Sequel.queryutf("delete from periksa_lab where periksa_lab.kategori='PA' and no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0) +
                                "' and tgl_periksa='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),4) +
                                "' and jam='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),5) +
                                "' and kd_jenis_prw='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),15).toString()+"'")==true){
                                if(Sequel.queryutf("delete from detail_periksa_labpa where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0) +
                                        "' and tgl_periksa='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),4) +
                                        "' and jam='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),5) +
                                        "' and kd_jenis_prw='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),15).toString()+"'")==false){
                                    sukses=false;
                                }else{
                            ...
                            if(sukses==true){
                                if(status.equals("Ranap")){
                                    ...
                                    if(sukses==true){
                                        sukses=jur.simpanJurnal(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),"U","PEMBATALAN PEMERIKSAAN LABORAT RAWAT INAP PASIEN "+tbDokter.getValueAt(tbDokter.getSelectedRow(),2).toString()+" OLEH "+akses.getkode());
                                    }
                                    ...
                                    if(sukses==true){
                                        sukses=jur.simpanJurnal(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),"U","PEMBATALAN PEMERIKSAAN LABORAT RAWAT JALAN PASIEN "+tbDokter.getValueAt(tbDokter.getSelectedRow(),2).toString()+" OLEH "+akses.getkode());
                                    }
                                }
                            }
    ...
    private void ppRiwayatBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRiwayatBtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(Kd2.getText().equals("")){
                ...
                resume.setNoRm(datapasien,tbDokter.getValueAt(tbDokter.getSelectedRow(),2).toString().replaceAll(datapasien+" ",""));
            ...
            try {   
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",rs.getString("kd_dokter"));
                        param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+rs.getString("nm_dokter")+"\nID "+(finger.equals("")?rs.getString("kd_dokter"):finger)+"\n"+rs.getString("tgl_periksa"));  
//                        sipdokter=Sequel.cariIsi("select dokter.no_ijn_praktek from dokter where dokter.kd_dokter=?",kodedokter);
                        finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",rs.getString("nip"));
                        param.put("finger2","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+rs.getString("nama")+"\nID "+(finger.equals("")?rs.getString("nip"):finger)+"\n"+rs.getString("tgl_periksa"));  
                        Sequel.queryu("delete from temporary_lab");
                        ...
                        param.put("sipdokter",Sequel.cariIsi("select dokter.no_ijn_praktek from dokter where dokter.kd_dokter=17111979"));
            ...
            try {   
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        param.put("pengirim",Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rs.getString("dokter_perujuk")));
                        param.put("tanggal",rs.getString("tgl_periksa"));
                        param.put("penjab",Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=17111979"));
                        param.put("petugas",rs.getString("nama"));
                        param.put("jam",rs.getString("jam"));
                        param.put("alamat",rs.getString("alamat"));
                        param.put("kamar",kamar);
                        param.put("namakamar",namakamar);
                        finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=17111979");
                        param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+" dr. FRAULEIN ARYATI, Sp.PK "+"\nID "+(finger.equals("")?"17111979":finger)+"\n"+rs.getString("tgl_periksa"));  
//                        finger2=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",rs.getString("nip"));
//                        param.put("finger2","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+rs.getString("nama")+"\nID "+(finger.equals("")?rs.getString("nip"):finger)+"\n"+rs.getString("tgl_periksa"));  
                        Sequel.queryu("delete from temporary_lab");
...
//                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
//                                Valid.MyReport("rptPeriksaLabPermintaanPA.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                                Valid.MyReport("rptPeriksaLabPermintaanPADTHJ.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLabPADTHJ.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
...
//                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabPermintaanPADTHJ2.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
//                                Valid.MyReport(""
//                                        + ".jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLabPADTHJ2.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
...
//                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabPermintaanPADTHJ3.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
//                                Valid.MyReport(""
//                                        + ".jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLabPADTHJ3.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
...
//                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabPermintaanPASGHJ.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
//                                Valid.MyReport(""
//                                        + ".jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLabPASGHJ.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
    ...
    */
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "ifnull((select group_concat(distinct pm.noorder separator ', ') from permintaan_labpa pm "+
                    "inner join permintaan_pemeriksaan_labpa pp on pm.noorder=pp.noorder "+
                    "where pm.no_rawat=periksa_lab.no_rawat and pp.kd_jenis_prw=periksa_lab.kd_jenis_prw),'') as noorder "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        rs.getString("no_rawat"),rs.getString("noorder"),rs.getString("no_rkm_medis")+" "+rs.getString("nm_pasien")+" ("+kamar+" : "+namakamar+")",rs.getString("nama"),
    ...
    private void getData() {
        ...
        if(tbDokter.getSelectedRow()!= -1){
            ...
            DiagnosaKlinis.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),10).toString());
            Makroskopis.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),11).toString());
            Mikroskopis.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),12).toString());
            Kesimpulan.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),13).toString());
            Kesan.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),14).toString());
        }
    }
            ...
            if(tbDokter.getSelectedRow()!= -1){
                try {
                    ...
                    try {
                        ...
                        ps.setString(4,tbDokter.getValueAt(tbDokter.getSelectedRow(),15).toString());
                        rs=ps.executeQuery();
                        if(rs.next()){
