        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(!tbObat.getValueAt(tbObat.getSelectedRow(),18).toString().equals("")){
                    ...
                    param.put("sipdokter",Sequel.cariIsi("select no_ijn_praktek from dokter inner join konsultasi_medik on konsultasi_medik.kd_dokter=dokter.kd_dokter where konsultasi_medik.no_permintaan=?",NoPermintaan.getText()));
                    param.put("sipdokter2",Sequel.cariIsi("select no_ijn_praktek from dokter inner join konsultasi_medik on konsultasi_medik.kd_dokter_dikonsuli=dokter.kd_dokter where konsultasi_medik.no_permintaan=?",NoPermintaan.getText()));
