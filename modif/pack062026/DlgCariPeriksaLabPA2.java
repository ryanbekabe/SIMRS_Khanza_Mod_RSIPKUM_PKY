...
public class DlgCariPeriksaLabPA2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPeriksaLabPA2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//        JOptionPane.showMessageDialog(this, utama.getLblUserValue(), "User Aktif", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pemeriksaan Laboratorium MDT dan Sputum ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Data Pemeriksaan Laboratorium MDT dan Sputum  ]::");
...
//                        sipdokter=Sequel.cariIsi("select dokter.no_ijn_praktek from dokter where dokter.kd_dokter=?",kodedokter);
                        ...
                        param.put("sipdokter",Sequel.cariIsi("select dokter.no_ijn_praktek from dokter where dokter.nm_dokter='"+rs.getString("nm_dokter")+"'"));
    ...
    private void MnCetakHasilLab3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLab3ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {   
                ps4=koneksi.prepareStatement(
                    "select periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.umur,petugas.nama,DATE_FORMAT(periksa_lab.tgl_periksa,'%d-%m-%Y') as tgl_periksa,periksa_lab.jam,periksa_lab.nip,"+
                    "periksa_lab.dokter_perujuk,periksa_lab.kd_dokter,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,dokter.nm_dokter,dokter.kd_dokter,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') as lahir "+
                    " from periksa_lab inner join reg_periksa inner join pasien inner join petugas  inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten "+
                    "on periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and periksa_lab.nip=petugas.nip and periksa_lab.kd_dokter=dokter.kd_dokter "+
                    "and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where periksa_lab.kategori='PA' and "+
                    "periksa_lab.tgl_periksa=? and periksa_lab.jam=? and periksa_lab.no_rawat=? group by concat(periksa_lab.no_rawat,periksa_lab.tgl_periksa,periksa_lab.jam)");
...
//                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
//                                Valid.MyReport("rptPeriksaLabPermintaanPA.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                                Valid.MyReport("rptPeriksaLabPermintaanPADTHJ.jasper","report","::[ Pemeriksaan Laboratorium - 2552 ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLabPADTHJ.jasper","report","::[ Pemeriksaan Laboratorium - 2554]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
...
//                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabPermintaanPADTHJ2.jasper","report","::[ Pemeriksaan Laboratorium - 2715 ]::",param);   
//                                Valid.MyReport(""
//                                        + ".jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLabPADTHJ2.jasper","report","::[ Pemeriksaan Laboratorium - 2719]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
...
//                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReport("rptPeriksaLabPermintaanPADTHJ3.jasper","report","::[ Pemeriksaan Laboratorium - 2881]::",param);   
//                                Valid.MyReport(""
//                                        + ".jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{
                                Valid.MyReport("rptPeriksaLabPADTHJ3.jasper","report","::[ Pemeriksaan Laboratorium - 2885]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaLabPA2 dialog = new DlgCariPeriksaLabPA2(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join dokter on periksa_lab.kd_dokter=dokter.kd_dokter where periksa_lab.kd_dokter IN ('17111979','14111992') and periksa_lab.kategori='PA' and "+
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join petugas on periksa_lab.nip=petugas.nip "+
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "where periksa_lab.kategori='PA' and periksa_lab.kd_dokter IN ('17111979','14111992') and periksa_lab.tgl_periksa between ? and ? group by pasien.no_rkm_medis order by tgl_registrasi desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,penjab.png_jawab,"+
                    "pasien.jk from pasien inner join reg_periksa on pasien.no_rkm_medis=reg_periksa.no_rkm_medis "+
                    ...
                    "inner join petugas on periksa_lab.nip=petugas.nip "+
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "where periksa_lab.kategori='PA' and periksa_lab.kd_dokter IN ('17111979','14111992') and periksa_lab.no_rawat like ? and reg_periksa.no_rkm_medis like ? and petugas.nip like ? and periksa_lab.tgl_periksa between ? and ? and "+
