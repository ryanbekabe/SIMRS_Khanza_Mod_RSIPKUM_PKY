    ...
    public boolean simpanJurnal(String nobukti,String jenis,String keterangan){  
        try {
            ...
            try {
                ...
                if(rscek.next()){
                    if(rscek.getDouble("debet")==rscek.getDouble("kredit")){
...
//                                                    System.out.println("Notif : Debet ("+rscek.getDouble("debet")+") dan Kredit ("+rscek.getDouble("kredit")+") tidak sama. Line 111");
                                                }
                                            }
                                        } catch (Exception e) {
                                             sukses=false;
                        ...
                        System.out.println("Notif :: Debet dan Kredit tidak sama");
//                        System.out.println("Notif : Debet dan Kredit tidak sama. Line 131 tes tes");
                        sukses=false;
                    }
                }
            } catch (Exception e) {
