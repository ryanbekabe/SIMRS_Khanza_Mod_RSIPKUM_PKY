        ...
        while (retries > 0) {
            try {
                ...
                System.out.println(
                    ...
                    "                            \n"+
                    "  *Pengembangan/modifikasi dari GitHub 20260812_20260820:                          \n"+
                    "  1) Form/Java:    \n"+
                    "     F) 1.1 fungsi/koneksiDB.java (1) (Changelog 21082026);\n"+
                    "        1.2 fungsi/sekuel.java (1) (AKTIFKANTRACKSQL paksa log semua aktifitas line ke 2060 21082026);\n"+
                    "     I) 1.1 inventory/DlgCariPenjualan.java (1) (Disable cetak ulang nota, ppCetakNota.setEnabled line ke 73/2229 21082026);\n"+
                    "        1.2 inventory/DlgCopyResep.java (1) (Silakan konfirmasi ke bagian Farmasi line ke 306, sepertinya sudah diperbaiki mas Win, BtnEdit BtnHapus setEnabled(false) 21082026 22092026);\n"+
                    "        1.3 inventory/DlgResepObat.java (0) (Tambah No.SEP di rptresep jika pasien BPJS, E-Tiket Obat, ED berdasarkan batch,RM,tgl_lhr,rev exp date join MAX expire; tambah panjang karakter NoResep, disable ED  line ke 185/1297/1489 mungkin sudah diperbaiki mas Windi 21082026);\n"+
                    "     K) 1.1 kepegawaian/DlgDokter.java (0) (Fungsi simpan dokter kedepan ikuti punya khanza maka modif Email di DB dari Github 28012026 03022026);\n"+
                    "                                                                           "
                );
                return;
