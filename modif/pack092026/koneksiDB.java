        ...
        if(connection == null){
            try{
                ...
                System.out.println("  Koneksi Berhasil. Sorry bro loading, silahkan baca dulu.... \n\n"+
                        ...
                        "        fungsi/sekuel.java (1) (AKTIFKANTRACKSQL, limit 1x24 cekTanggal48jam, jadikan kembali 2x24 jam 07052026 06072026);\n"+
                        
                        "        inventory/DlgCariPenjualan.java (1) (Disable cetak ulang nota, ppCetakNota.setEnabled true 15092025,01102025);\n"+
                        "        inventory/DlgCopyResep.java (1) (Silakan konfirmasi ke bagian Farmasi, disabel Edit dan Hapus Req LI 16092026);\n"+
                        "        inventory/DlgInputStok.java (0 lewati dulu) (Tambah kolom Ekspired);\n"+
                        "        inventory/DlgPenjualan.java (1) (Disable cetak Nota,BtnNota.setEnabled true 25092025,01102025);\n"+
                        "        inventory/DlgPermintaanResepPulang.java (1) (Sembunyikan stok obat yang kosong, perbaiki doubling 28082025, 10092025);\n"+
                        "        inventory/DlgResepObat.java (1) (Tambah No.SEP di rptresep jika pasien BPJS, E-Tiket Obat, ED berdasarkan batch,RM,tgl_lhr,rev exp date join MAX expire; tambah panjang karakter NoResep, disable ED  25092025,29092025,10102025,23042026);\n"+
                        ...
                        "        permintaan/DlgCariPermintaanRadiologi.java (1) (KOP, Penanggung Jawab, Kamar aktif (-) yang masuk ke permintaan 28012026 10092026);\n"+
                        ...
                        "        rekammedis/RMDataResumePasienRanap.java (1) (KOP Surat, Tgl. Keluar, Print pilih DPJP utama Resume, Disable Edit Resume jika sudah close bill req RQ, Buka Edit Resume true untuk tim Casemix 08122025 24062026 01082026 02092026);\n"+
                        ...
                        "        rekammedis/RMSkriningMPPFormA.java (0) (Tampilkan asesmen di report req NC 12092026);\n"+ 
                        
                        
                        "        simrskhanza/DlgAbout.java (1) (Versi Git dan build app 13062025 11072025 02082025 25092025);\n"+
                        "        simrskhanza/DlgCariPeriksaLab.java (1) (Judul pemeriksaan Lab. tetap di atas, tambah Kesan Saran di report 08072026);\n"+
                        ...
                        "        rptBarcodeRawat.jasper (1) (PRB, <17thn LK/PR 09092025);\n"+
                        ...
                        "        rptItemResep.jasper (1) (E-Tiket penambahan Bismillah dan ED RM, revisi ED berdasar batch 10072025,25092025);\n"+
                        
                        "        rptFormulirSkriningTBC.jasper (1) (KOP Surat);\n"+
                        "        rptFormulirSkriningTBCD.jasper (0);\n"+
                        
                        "        rptLabelDiet.jasper (1) (Menu layak konsumsi jam ...);\n"+
                        "        rptLaporanOperasi.jasper (1) (KOP Surat, SIP 02082025);\n"+
                        "        rptLaporanResume.jasper (1) (KOP Surat, SIP);\n"+
                        "        rptLaporanResumeRanap.jasper (1) (KOP Surat);\n"+
                        
                        "        rptPeriksaLab.jasper (1)(Short, SIP dr., dr. Kepala Lab. dan PJ beda 06062026);\n"+
                        "        rptPeriksaLabPermintaan.jasper (1) (SIP dr., dr. Kepala Lab. dan PJ beda, tambah Kesan dan Saran 13062025 06062026 08072026);\n"+
                        "        rptPeriksaLab2.jasper (1)(Long);\n"+
                        "        rptPeriksaLab2Permintaan.jasper (1 13062025) (SIP dr., tambah Kesan dan Saran 08072026);\n"+
                        "        rptPeriksaLab3.jasper (1)(Swab);\n"+
                        "        rptPeriksaLab3Permintaan.jasper (0) (0);\n"+
                        ...
                        "        rptPeriksaLabPADTHJ.jasper (1) (SIP dokter, support dr. spesialis lebih dari 1, rapikan jarak SIP 19062025 09062026 08072026);\n"+
                        "        rptPeriksaLabPADTHJ2.jasper (1) (SIP dokter, support dr. spesialis lebih dari 1, 19062025 09062026);\n"+
                        "        rptPeriksaLabPADTHJ3.jasper (1) (SIP dokter, support dr. spesialis lebih dari 1, rapikan jarak SIP 19062025 09062026 08072026);\n"+
                        "        rptPeriksaLabPAHJ.jasper (1) (No.Permintaan 15052026 09062026);\n"+
                        "        rptPeriksaLabPASGHJ.jasper (1) (SIP dokter, support dr. spesialis lebih dari 1, rapikan jarak SIP 15062026 08072026);\n"+
                        ...
                        "  Re-Compile_by: Bang Riyan Samosir - www.HanyaJasa.Com - hanyajasa@gmail.com, 17/09/2026 09.22 - RS Islam PKU Muhammadiyah Palangka Raya. \n"+
                        "                                                                           ");
