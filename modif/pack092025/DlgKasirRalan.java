...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private String adamjkn=" - MJKN",tidakadamjkn="";
    ...
    private void initComponents() {
        ...
        MnCetakSuratSehat2.setText("Surat Keterangan Sehat 3 - Oke");
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, "+
                "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp "+
//                "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp,referensi_mobilejkn_bpjs.jeniskunjungan "+

                "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
//                "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join referensi_mobilejkn_bpjs on reg_periksa.no_rawat=referensi_mobilejkn_bpjs.no_rawat "+
                "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where  "+
            ...
            try{
                ...
                rskasir=pskasir.executeQuery();
                adamjkn="";tidakadamjkn="";
                while(rskasir.next()){
                    
                    adamjkn=Sequel.cariIsi("select if(count(referensi_mobilejkn_bpjs.no_rawat)>0,'Ada','Tidak Ada') from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.no_rawat=?",rskasir.getString("no_rawat"));
                    if(adamjkn.equals("Ada")){
                        adamjkn=" - MJKN";
                    }else{
                        adamjkn="";
                    }
                    ...
                    tabModekasir.addRow(new String[] {
                        ...
                        rskasir.getString("png_jawab")+ adamjkn,rskasir.getString(14),rskasir.getString("no_rawat"),rskasir.getString("tgl_registrasi"),
//                        rskasir.getString("png_jawab")+ " - BKB jenis bayar ",rskasir.getString(14),rskasir.getString("no_rawat"),rskasir.getString("tgl_registrasi"),
                        rskasir.getString("jam_reg"),rskasir.getString(1),rskasir.getString("status_bayar"),rskasir.getString("status_poli"),
                        rskasir.getString("kd_pj"),rskasir.getString("kd_poli"),rskasir.getString("no_tlp")+" - BKB tampilkasir1ok"
                    });
                }                
            } catch(Exception e){
            ...
            try{
                ...
                while(rskasir.next()){
                    tabModekasir2.addRow(new String[] {
                        ...
                        rskasir.getString("jam_reg"),rskasir.getString("kd_poli"),rskasir.getString("kd_pj"),rskasir.getString("no_tlp") +" - BKB tampilkasir2"
                    });
                }                
            } catch(Exception e){
                System.out.println("Notifikasi : "+e);
