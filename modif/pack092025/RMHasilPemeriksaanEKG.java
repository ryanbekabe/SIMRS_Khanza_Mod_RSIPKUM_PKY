...
public final class RMHasilPemeriksaanEKG extends javax.swing.JDialog {
    ...
    public RMHasilPemeriksaanEKG(java.awt.Frame parent, boolean modal) {
        ...
        SegmenST.setVisible(false); 
        GelombangT.setVisible(false);
    ...
    private void initComponents() {
        ...
        tbSegmenST = new widget.TextBox();
        tbGelombangT = new widget.TextBox();
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-08-2025 07:56:30" }));
        ...
        SegmenST.setBounds(10, 363, 30, 10);
        ...
        GelombangT.setBounds(10, 393, 30, 10);
        ...
        tbSegmenST.setFocusTraversalPolicyProvider(true);
        tbSegmenST.setName("tbSegmenST"); // NOI18N
        tbSegmenST.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbSegmenSTKeyPressed(evt);
            }
        });
        FormInput.add(tbSegmenST);
        tbSegmenST.setBounds(90, 200, 270, 23);

        tbGelombangT.setFocusTraversalPolicyProvider(true);
        tbGelombangT.setName("tbGelombangT"); // NOI18N
        tbGelombangT.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbGelombangTKeyPressed(evt);
            }
        });
        FormInput.add(tbGelombangT);
        tbGelombangT.setBounds(454, 200, 270, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-08-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-08-2025" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        System.out.println("Notifikasi KdDokter.getText 1380 ");
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("sipdokter",Sequel.cariIsi("select dokter.no_ijn_praktek from dokter where dokter.kd_dokter='"+tbObat.getValueAt(tbObat.getSelectedRow(),4).toString()+"'"));
            System.out.println("Notifikasi KdDokter.getText 1393 ");
            System.out.println("Notifikasi KdDokter.getText: "+tbObat.getValueAt(tbObat.getSelectedRow(),4).toString());
    ...
    private void tbSegmenSTKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSegmenSTKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbSegmenSTKeyPressed

    private void tbGelombangTKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbGelombangTKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbGelombangTKeyPressed
    ...
    */
    ...
    private widget.TextBox tbGelombangT;
    private widget.Table tbListDicom;
    private widget.Table tbObat;
    private widget.TextBox tbSegmenST;
...
//        GelombangT.setSelectedIndex(0);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            tbSegmenST.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
//            SegmenST.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            tbGelombangT.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
//            GelombangT.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("hasil_pemeriksaan_ekg","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,irama=?,laju_jantung=?,gelombangp=?,"+
                ...
                KompleksQRS.getText(),tbSegmenST.getText(),tbGelombangT.getText(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
//                KompleksQRS.getText(),tbSegmenST.getText(),GelombangT.getSelectedItem().toString(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
//                KompleksQRS.getText(),SegmenST.getSelectedItem().toString(),GelombangT.getSelectedItem().toString(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                ...
                tbObat.setValueAt(tbSegmenST.getText(),tbObat.getSelectedRow(),15);
//                tbObat.setValueAt(SegmenST.getSelectedItem().toString(),tbObat.getSelectedRow(),15);
                tbObat.setValueAt(tbGelombangT.getText(),tbObat.getSelectedRow(),16);
//                tbObat.setValueAt(GelombangT.getSelectedItem().toString(),tbObat.getSelectedRow(),16);
    ...
    private void simpan() {
        if(Sequel.menyimpantf("hasil_pemeriksaan_ekg","?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",14,new String[]{
                ...
                Axis.getText(),KompleksQRS.getText(),tbSegmenST.getText(),tbGelombangT.getText(),Kesimpulan.getText()
//                Axis.getText(),KompleksQRS.getText(),tbSegmenST.getText(),GelombangT.getSelectedItem().toString(),Kesimpulan.getText()
//                Axis.getText(),KompleksQRS.getText(),SegmenST.getSelectedItem().toString(),GelombangT.getSelectedItem().toString(),Kesimpulan.getText()
                ...
                tabMode.addRow(new String[]{
                    ...
                    KirimanDari.getText(),DiagnosaKlinis.getText(),Irama.getText(),LajuJantung.getText(), GelombangP.getText(),IntervalPR.getText(),Axis.getText(),KompleksQRS.getText(),tbSegmenST.getText(),
//                    KirimanDari.getText(),DiagnosaKlinis.getText(),Irama.getText(),LajuJantung.getText(), GelombangP.getText(),IntervalPR.getText(),Axis.getText(),KompleksQRS.getText(),SegmenST.getSelectedItem().toString(),
                    tbGelombangT.getText(),Kesimpulan.getText()
