        ...
        if(tabMode.getRowCount()==0){
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep.jasper","report","::[ Aturan Pakai Obat ]::",
                    ...
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,databarang.nama_brng,databarang.expire,data_batch.tgl_kadaluarsa,"+
                    ...
                    "inner join kodesatuan inner join data_batch on resep_obat.no_rawat=reg_periksa.no_rawat  "+
                    "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and "+
                    "databarang.kode_brng=aturan_pakai.kode_brng and "+
                    "data_batch.kode_brng=databarang.kode_brng and "+
                    ...
                    "where resep_obat.no_resep='"+NoResep.getText()+"' and aturan_pakai.aturan<>'' order by data_batch.tgl_kadaluarsa desc limit 1",param);
            }
