...
//            param.put("sipdokter",Sequel.cariIsi("SELECT dokter.no_ijn_praktek FROM periksa_radiologi INNER JOIN petugas ON petugas.nip=periksa_radiologi.nip INNER JOIN dokter ON dokter.kd_dokter=petugas.nip WHERE periksa_radiologi.no_rawat=?",Kd2.getText()));
