...
//            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            ...
            param.put("sipdokter",Sequel.cariIsi("select no_ijn_praktek from dokter inner join penilaian_medis_ranap on penilaian_medis_ranap.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap.no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()));
            System.out.println("No Rawat penilaian_medis_ranap untuk dapatkan sipdokter : "+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
