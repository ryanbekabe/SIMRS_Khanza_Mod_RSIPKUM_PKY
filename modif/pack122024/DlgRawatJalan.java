...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        TindakLanjutx.setDocument(new batasInput((int)2000).getKata(TindakLanjutx));
        TindakLanjutxb.setDocument(new batasInput((int)2000).getKata(TindakLanjutxb));
        TindakLanjutxc.setDocument(new batasInput((int)2000).getKata(TindakLanjutxc));
        TindakLanjutxd.setDocument(new batasInput((int)2000).getKata(TindakLanjutxd));
    ...
    private void initComponents() {
        ...
        scrollPane16b = new widget.ScrollPane();
        scrollPane16c = new widget.ScrollPane();
        scrollPane16d = new widget.ScrollPane();
        TindakLanjut = new widget.TextArea();
        TindakLanjutx = new widget.TextArea();
        TindakLanjutxb = new widget.TextArea();
        TindakLanjutxc = new widget.TextArea();
        TindakLanjutxd = new widget.TextArea();
...
//        jLabel128.setText("S (Situation)-bkb :");
//        jLabel128.setName("jLabel128"); 
//        panelGlass12.add(jLabel128);
//        jLabel128.setBounds(920, 40, 120, 23);
...
//        jLabel126.setText("B (Background)-bkb :");
//        jLabel126.setName("jLabel126"); 
//        panelGlass12.add(jLabel126);
//        jLabel126.setBounds(920, 85, 120, 23);
        
        TindakLanjutx.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TindakLanjutx.setColumns(20);
        TindakLanjutx.setRows(5);
        TindakLanjutx.setName("TindakLanjutx"); 
        scrollPane16.setViewportView(TindakLanjutx);
        panelGlass12.add(scrollPane16);
        scrollPane16.setBounds(1043, 85, 360, 47);
        scrollPane16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane16.setName("scrollPane16"); 

        TindakLanjutxb.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TindakLanjutxb.setColumns(20);
        TindakLanjutxb.setRows(5);
        TindakLanjutxb.setName("TindakLanjutxb"); 
        scrollPane16b.setViewportView(TindakLanjutxb);
        panelGlass12.add(scrollPane16b);
        scrollPane16b.setBounds(1043, 35, 360, 47);
        scrollPane16b.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane16b.setName("scrollPane16b"); 
        
        TindakLanjutxc.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TindakLanjutxc.setColumns(20);
        TindakLanjutxc.setRows(5);
        TindakLanjutxc.setName("TindakLanjutxc"); 
        scrollPane16c.setViewportView(TindakLanjutxc);
        panelGlass12.add(scrollPane16c);
        scrollPane16c.setBounds(1043, 135, 360, 47);
        scrollPane16c.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane16c.setName("scrollPane16c"); 

        TindakLanjutxd.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TindakLanjutxd.setColumns(20);
        TindakLanjutxd.setRows(5);
        TindakLanjutxd.setName("TindakLanjutxd"); 
        scrollPane16d.setViewportView(TindakLanjutxd);
        panelGlass12.add(scrollPane16d);
        scrollPane16d.setBounds(1043, 185, 360, 47);
        scrollPane16d.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane16d.setName("scrollPane16d"); 
...
//        jLabel153.setText("A (Assessment)-bkb :");
//        jLabel153.setName("jLabel153"); 
//        panelGlass12.add(jLabel153);
//        jLabel153.setBounds(920, 139, 120, 23);        
...
//        jLabel156.setText("R (Recommendation)-bkb :");
//        jLabel156.setName("jLabel156"); 
//        panelGlass12.add(jLabel156);
//        jLabel156.setBounds(920, 196, 120, 23);        
    ...
    private void BtnBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalActionPerformed
        ...
        TindakLanjutx.setText("");
        TindakLanjutxb.setText("");
        TindakLanjutxc.setText("");
        TindakLanjutxd.setText("");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    private widget.TextArea TindakLanjutx;
    private widget.TextArea TindakLanjutxb;
    private widget.TextArea TindakLanjutxc;
    private widget.TextArea TindakLanjutxd;
    ...
    private widget.ScrollPane scrollPane16b;
    private widget.ScrollPane scrollPane16c;
    private widget.ScrollPane scrollPane16d;
