...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    public SuratBebasNarkoba(java.awt.Frame parent, boolean modal) {
        ...
        NoSurat.setDocument(new batasInput((byte)30).getKata(NoSurat)); //20
        TNoRw.setDocument(new batasInput((byte)17).getKata(TNoRw));  
        Keperluan.setDocument(new batasInput((byte)100).getKata(Keperluan));         //50
    ...
    private void initComponents() {
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-05-2023" }));
