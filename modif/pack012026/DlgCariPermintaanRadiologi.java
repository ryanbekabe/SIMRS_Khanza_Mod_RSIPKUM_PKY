...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private String alarm="",formalarm="",nol_detik,detik,tglsampel="",tglhasil="",norm="",kdpj="",kamar="",namakamar="",
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(tbRadiologiRalan.getSelectedRow()!= -1){
                ...
                if(NoPermintaan.trim().equals("")){
                    ...
                    kdpj=Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=? ",NoRawat);
                    param.put("norm",norm);
                    param.put("kdpjnm",Sequel.cariIsi("select penjab.png_jawab from penjab where penjab.kd_pj=? ",kdpj));
