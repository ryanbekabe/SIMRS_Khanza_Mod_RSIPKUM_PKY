            ...
            try{
                ...
                if(centangobatralan.equals("Yes")){
                    if(rsobatoperasi.next()){
                        ...
                        tabModeRwJlDr.addRow(new Object[]{true, "", "Total Obat & BHP Operasi : " + Valid.SetAngka(subttlopb), ".",  null, null, null, null, "Obat"});
                    }
                }else{
                    if(rsobatoperasi.next()){
                        rsobatoperasi.beforeFirst();
    ...
    private void prosesCariOperasi(){
        try{            
            ...
            try {
                ...
                if(subttl > 0){
                    tabModeRwJlDr.addRow(new Object[]{true,"","Total Operasi : "+Valid.SetAngka(subttl),"",null,null,null,null,"Operasi"});
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);
            } finally{
