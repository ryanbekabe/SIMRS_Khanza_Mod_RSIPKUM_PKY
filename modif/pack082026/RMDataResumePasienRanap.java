...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private String kodekamar="",namakamar="",tglkeluar="",jamkeluar="",finger="",fingerb="",fingerc="",fingerd="",fingerbx="",fingercx="",fingerdx="",fingerbxx="",fingercxx="",fingerdxx="";
    ...
    // Tambahkan listener manual
    jCheckBox1.addActionListener(new java.awt.event.ActionListener() {
        @Override
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            jLabel19.setVisible(!jCheckBox1.isSelected());
        }
    });
    ...
    private void initComponents() {
        ...
        jCheckBox1.setLabel("Tgl.Keluar");
        ...
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-02-2025 11:05:59" }));
...
public void tampil() {
    ...
    try{
        ...
        if(jCheckBox1.isSelected()){
            // filter berdasarkan kamar_inap.tgl_keluar
            filterTgl =
                "exists (select 1 from kamar_inap " +
                "        where kamar_inap.no_rawat=reg_periksa.no_rawat " +
                "          and kamar_inap.tgl_keluar between ? and ?)";
        }else{
            // filter berdasarkan reg_periksa.tgl_registrasi (default)
            filterTgl = "reg_periksa.tgl_registrasi between ? and ?";
        }
        ...
        rs = ps.executeQuery();
        // lanjutkan proses rs persis seperti kode Anda sekarang (ps2, tabMode.addRow, dst)
                while(rs.next()){
...
//                this,                      // parent component (bisa juga null)
//                "Checkbox dicentang!",     // pesan yang ditampilkan
//                "Informasi",               // judul messagebox
//                javax.swing.JOptionPane.INFORMATION_MESSAGE // tipe icon
//            );
//        }
//        Valid.tabelKosong(tabMode);
//        try{
...
//    }
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TNoRw.setText(noRw);  
//            JOptionPane.showMessageDialog(this, "Nomor Rawat: " + noRw, "Informasi NoRw", JOptionPane.INFORMATION_MESSAGE);
