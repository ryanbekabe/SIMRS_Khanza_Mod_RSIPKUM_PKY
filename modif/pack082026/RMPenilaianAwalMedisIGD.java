/*rekammedis/RMPenilaianAwalMedisIGD.java (0) (V. DIAGNOSIS/ASESMEN DAN RETRIASE jLabel102, BtnEdit disable jika Ranap), private void getData();
    ...
    */
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            String noRw = tbObat.getValueAt(tbObat.getSelectedRow(),0).toString();
            // TNoRw.setText(noRw);
            // JOptionPane.showMessageDialog(this, "Nomor Rawat 2318: " + noRw, "Informasi NoRw", JOptionPane.INFORMATION_MESSAGE);
            // TNoRw.setText(tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()); 
//            if(Sequel.cariRegistrasi(noRw.toString())>0){
