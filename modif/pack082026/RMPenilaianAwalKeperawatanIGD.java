    ...
    */
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TNoRw.setText(noRw);
            // JOptionPane.showMessageDialog(this, "Nomor Rawat 4170: " + noRw, "Informasi NoRw", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void isRawat() {
        try {
            ...
            try {
                ...
                // String noRw = tbObat.getValueAt(tbObat.getSelectedRow(),0).toString();
                // TNoRw.setText(noRw);
                // JOptionPane.showMessageDialog(this, "Nomor Rawat 4288: " + noRw, "Informasi NoRw", JOptionPane.INFORMATION_MESSAGE);
